...
function ive_save_general_settings() {
	...
	$ive_save_general_settings['google_api_key']	=	$_POST['google_api_key'];
	$ive_save_general_settings['ive_custom_css']	=	stripcslashes( $_POST['ive_custom_css'] );
	$ive_save_general_settings['ive_custom_js']		=	stripcslashes( $_POST['ive_custom_js'] );
