				...
				$( document ).ready( function () {
					jQuery(
						...
						`<p id="ive_product_metabox_license" class="ive_go_pro_metabox_p">
							Get pre-built premium product page templates using <strong>Ibtana - Ecommerce Product Addons.</strong><br>
							<a class="ive_go_pro_metabox_a2 button" href="https://www.vwthemes.com/plugins/woocommerce-product-add-ons/" target="_blank">Upgrade To Pro!</a>
						</p>`
					);
				});
										...
										if ( !data.data.is_found ) {
											...
											$( '#ive_go_pro_template_metabox .inside' ).append(
												`<p id="ive_go_pro_metabox_p" class="ive_go_pro_metabox_p">
													...
													<br>
													<a class="ive_go_pro_metabox_a1 button" href="https://www.vwthemes.com/premium/theme-bundle/" target="_blank">Buy Now!</a>
												</p>`
											);
		...
		if ( $post_temp_type	==	'woocommerce' ) {
			...
			if( isset( $home_id ) ) {
				...
				if ( isset( $_POST['ive_template_text_domain'] ) ) {
					update_option( 'ive_active_vw_theme_text_domain', $_POST['ive_template_text_domain'] );
				}
			...
			<div class="ive-get-started-container ive-get-started-main-container">
				<div class="">
					...
					<div class="ive-get-started-blocks-accordion">
						<button class="ive-block-accordion-btn"><span class="dashicons dashicons-screenoptions ive-accordion-title-icon"></span>Ibtana Blocks<span class="dashicons dashicons-arrow-down ive-accordion-icon"></span></button>
						...
						<button class="ive-block-accordion-btn"><span class="dashicons dashicons-screenoptions ive-accordion-title-icon"></span>Woocommerce Blocks<span class="dashicons dashicons-arrow-down ive-accordion-icon"></span></button>
						<div class="panel ive-get-started-block-activation">
							<?php
								$ive_block_json = file_get_contents(plugin_dir_url(__FILE__).'ive-blocks.json');
								$ive_blocks = json_decode($ive_block_json, true);
...
class Ibtana_Visual_Editor_Menu_Creator extends Ibtana_Visual_Editor_Menu_Class {
	...
	public function ibtana_visual_editor_ive_envato_page() {
		...
		// } else {
		// 	$license_messege = __(
		// 		'Enter your add-ons license keys here to receive updates for purchased add-ons.',
		// 		'ibtana-visual-editor'
		// 	);
		// }
		?>
