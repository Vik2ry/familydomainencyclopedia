...
function knowledge_base_lite_activation_notice() {
	...
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=knowledge_base_lite_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'knowledge-base-lite' ) .'</a></p>';
	echo '</div>';
}
...
function knowledge_base_lite_scripts() {
	...
	wp_enqueue_script( 'knowledge-base-lite-custom-scripts-jquery', esc_url(get_template_directory_uri()) . '/assets/js/custom.js', array('jquery'),'' ,true );	
...
define('KNOWLEDGE_BASE_LITE_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-knowledge-base/','knowledge-base-lite'));
...
define('KNOWLEDGE_BASE_LITE_BUY_NOW',__('https://www.vwthemes.com/themes/knowledge-base-wordpress-theme/','knowledge-base-lite'));
define('KNOWLEDGE_BASE_LITE_LIVE_DEMO',__('https://www.vwthemes.net/vw-knowledge-base-pro/','knowledge-base-lite'));
define('KNOWLEDGE_BASE_LITE_PRO_DOC',__('https://www.vwthemesdemo.com/docs/vw-knowledge-base-pro/','knowledge-base-lite'));
...
define('KNOWLEDGE_BASE_LITE_CREDIT',__('https://www.vwthemes.com/themes/free-knowledge-base-wordpress-theme/','knowledge-base-lite'));
